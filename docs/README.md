...
- **[Plain JS & no build step](./plain-js.md)** - using p5 without imports/modules/TypeScript, and the global → instance conversion
...
- **[Examples](./examples/)** - runnable demos
  - [`00-plain-js`](./examples/00-plain-js) - no install, no bundler: plain p5 HTML files
